...
KBRemoveProps.Language = {
	["en"] = {
		...
		["singlePlayer"] = "You are on singleplayer KBRemoveProps is disabled and cannot work please launch a peer to peer server",
		["toolLeft"] = "Left-click to remove the entity that you are looking at",
		["succesfulyRemoved"] = "Successfully removed the entity with the map creation id #%s",
		["succesfulyRemovedRemove"] = "Successfully removed from the database the entity with the map creation id #%s (Cleanup or restart to respawn it)",
	...
	["tr"] = {
		["toolName"] = "KB Removeprops",
		["toolDesc"] = "Varsayılan haritanızda oluşturulan nesneleri kaldırın",
		["singlePlayer"] = "Tek oyunculuda 'KBRemoveProps' kullanıyorsunuz. Lütfen eklentinin çalışması için eşler arası bir sunucu başlatın",
		["toolLeft"] = "Baktığınız varlığı kaldırmak için sol tıklayın",
		["succesfulyRemoved"] = "Harita oluşturma kimliği #%s olan varlığı başarıyla kaldırıldı",
		["succesfulyRemovedRemove"] = "Harita oluşturma kimliği #%s olan varlık veri tabanından başarıyla kaldırıldı (Yeniden başlatmak için temizleyin veya yeniden başlatın)",
		["removePropsId"] = "KB RemoveProps - ID #%s",
		["noEntitiesRemoved"] = "Hiçbir varlık kaldırılmadı",
		["noEntitiesRemovedDesc"] = "Henüz hiçbir varlığı kaldırmadınız",
	},
	["fr"] = {
		["toolName"] = "KB Removeprops",
		["toolDesc"] = "Remove props created on your default map",
...
if CLIENT then
	...
	if KBRemoveProps.Mysql then
		...
		mysqlDB = mysqloo.connect(KBRemoveProps.MysqlInformations["host"], KBRemoveProps.MysqlInformations["username"], KBRemoveProps.MysqlInformations["password"], KBRemoveProps.MysqlInformations["database"], KBRemoveProps.MysqlInformations["port"])
